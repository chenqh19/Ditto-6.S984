...
void* blockingThread(int connfd, TCPConn* conn, uint64_t* pointer_chasing_mem_data)
{
    ...
    for (int i = 0; i < 23; i++) {
        ...
        curr_pointer_chasing_mem_addrs[i] = (uint64_t)&pointer_chasing_mem_data[curr_idx];
